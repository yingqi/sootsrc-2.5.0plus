...
public abstract class UnitGraphPlus implements DirectedGraph<Unit>
{
     ...
     *               control flow graph.
     */
    protected UnitGraphPlus( Body body) {
	this.body = body;
	unitChain = body.getUnits();
	head = new BeginStmt();
	tail = new EndStmt();
	unitChain.addFirst(head);
	unitChain.addLast(tail);
